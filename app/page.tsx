          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl mb-10 text-gray-300 leading-relaxed">
                Join our vibrant community. Explore, collaborate, and thrive in
                our engaging SMP environment.
              </p>
        ...
        >
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-gray-900 rounded-xl p-6 shadow-md transition-all duration-300 hover:shadow-xl hover:bg-gray-800 border border-purple-600">
                <div className="flex items-center justify-center mb-4">
                  <FaUser className="h-10 w-10 text-purple-400" />
                </div>
                <p className="text-center text-xl font-medium text-purple-300">
                  {loading
                    ? "Loading..."
              ...
              <div className="bg-gray-900 rounded-xl p-6 shadow-md transition-all duration-300 hover:shadow-xl hover:bg-gray-800 border border-pink-600">
                <div className="flex items-center justify-center mb-4">
                  <FaPaperPlane className="h-10 w-10 text-pink-400" />
                </div>
                <p className="text-center text-xl font-medium text-pink-300">
                  {loading ? "Loading..." : serverStatus.software}
                </p>
                <p className="text-center text-sm text-gray-500">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-800 bg-opacity-60 backdrop-blur-sm rounded-xl p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center hover:bg-opacity-70 transition-all duration-300">
                    <div className="mb-3 sm:mb-0">
                      ...
                      <p className="text-lg font-medium text-teal-100">19141</p>
                    </div>
                    <ClipboardButton
                      text="19141"
                      buttonStyle="bg-teal-700 hover:bg-teal-800 text-white rounded-lg px-4 py-2 transition-all duration-300 mt-2 sm:mt-0"
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-900 rounded-lg shadow-lg p-6 border-2 border-blue-600 transition duration-300 hover:shadow-xl hover:bg-gray-800">
                ...
                <p className="text-gray-400 text-center">
                  Play with friends across Minecraft Java and Bedrock editions.
                </p>
              </div>
            </div>
          </div>
